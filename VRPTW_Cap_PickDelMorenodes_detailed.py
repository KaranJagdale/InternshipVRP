...
#    data['demands'] = [0, 2, 4, -1, 1, 2, 3, 11, -5, -5, -4, -3, 2, 1, -9, -2, 3]
    data['vehicle_capacities'] = [50, 50, 50, 50, 50, 50]
    data['num_vehicles'] = 6
    data['depot'] = 22
    return data
...
def main():
    ...
    print("1")
   # t1 = time.time()
    df = pd.read_csv('/home/karan/InternShipCodes/csv/FL_insurance_sample/101nodesBanglore.csv') 
    entries = df.to_numpy()
    length = (len(entries))
    print("2")
    #print(entries[0][0])
...
#    print(data['time_windows'])
    ...
    routing.AddDimension(
        ...
        20000,  # maximum time per vehicle
